...
const IconSet = {
    ...
    search: {
        viewBox: '0 0 22 22',
        __html: `
            <path fill-rule="evenodd" clip-rule="evenodd" d="M16 9.5C16 13.0899 13.0899 16 9.5 16C5.91015 16 3 13.0899 3 9.5C3 5.91015 5.91015 3 9.5 3C13.0899 3 16 5.91015 16 9.5ZM4 9.5C4 12.5376 6.46243 15 9.5 15C12.5376 15 15 12.5376 15 9.5C15 6.46243 12.5376 4 9.5 4C6.46243 4 4 6.46243 4 9.5ZM18.3464 19.0536L14.3464 15.0536L15.0536 14.3464L19.0536 18.3464L18.3464 19.0536Z" fill="#ffffff"/>        
        `
    }
}
...
export default function Icon ({ name, style, size = 22 }) {
    ...
    return (
        <svg
            ...
            dangerouslySetInnerHTML={IconSet[name]}
        />
    )
}
